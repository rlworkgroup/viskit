...
latex_documents = [
    (master_doc, 'viskit.tex', 'viskit Documentation',
...
man_pages = [(master_doc, 'viskit', 'viskit Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'viskit', 'viskit Documentation', author, 'viskit',
